 ...
 * @author PC2
 */
public class IdSearch extends Application {
    ...
    public void start(Stage primaryStage) {
         ...
         ImageView img = new ImageView("file:///C:/Users/PC2/Desktop/%D8%AC%D8%A7%D9%85%D8%B9%D8%A9/elictronic/%D9%85%D8%B9%D9%85%D9%84/11.jpg");
          ...
          Text title = new Text("Search for a student record (by ID) ");
  ...
  l3.setStyle("-fx-font: 40 arial; -fx-base: #b6e7c9;");
    ...
    btAdd.setOnAction(new EventHandler<ActionEvent>() { 
            @Override
                    public void handle(ActionEvent e) {
                          ...
                          int n = Integer.parseInt(StudentID.getText());
     int k=0;
     for(int i=0 ; i<Student.numOfStudents; i++ ){
           if(Number.student[i].getID()==n){
                 k++;
        ...
        primaryStage.show();
           ...
           if(k==0){
            VBox pane1 = new VBox(15);
                          pane1.setStyle("-fx-background-color:#b6e7c9;-fx-padding:10px;");
                     System.out.println("");
                     Label la = new Label("\nERROR: there is no record for student name # " + n);
                     Button bt= new Button("Back");
   ...
   Scene scene = new Scene(pane ,580,300 );
       primaryStage.setTitle("ID Search");
        primaryStage.setScene(scene);
        primaryStage.show();
    }
